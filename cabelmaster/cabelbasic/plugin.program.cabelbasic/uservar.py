...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR darkcyan]Cabelbasic [/COLOR]All In One Wizard'
BUILDERNAME = 'Cabel Basic Wizard'
EXCLUDES = [ADDON_ID, 'plugin.program.cabelbasic']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/cabelw1985/cabelmaster/master/cabelmaster/cabelbasic/wizard/builds.txt'
...
YOUTUBEFILE = 'https://raw.githubusercontent.com/cabelw1985/cabelmaster/master/cabelmaster/cabelbasic/wizard/youtube.txt'
# Text File for addon installer.  Leave as 'http://' to ignore
ADDONFILE = ''
# Text File for advanced settings.  Leave as 'http://' to ignore
ADVANCEDFILE = 'https://raw.githubusercontent.com/cabelw1985/cabelmaster/master/cabelmaster/cabelbasic/wizard/advanced.txt'
#########################################################
