...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR darkcyan]cabelprivat [/COLOR]Virus nicht laden '
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Cabelprivat[/B][/COLOR][COLOR {color2}]Virus nicht laden[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
REPOID = 'plugin.program.cabelprivat'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR darkcyan]Cabelprivat [/COLOR]Virus nicht laden '
